 ...
 *
 * Module plugin:
 *  OVMS Vehicle Sound for Pedestrians.
 *
 * Version 1.0   Biddster <@biddster>
 *
 * Heavily based on foglight.js by Michael Balzer <dexter@dexters-web.de>
 *
 * Enable:
...
function checkspeed() {
    ...
    if (speed <= cfg['foglight.speed.on']) toggle(1);
    else if (speed >= cfg['foglight.speed.off']) toggle(0);
}
